...
## 4. Who are you?
Write a program that prints all the names defined by the compiled module <a href='https://github.com/alx-tools/0x02.py/raw/master/hidden_4.pyc'>hidden_4.pyc</a> (please download it locally).  
...
```
 ...
 10     >>   94 LOAD_FAST                3 (sub)
            ...
            110 RETURN_VALUE
Tip: Python <a href='https://intranet.alxswe.com/rltoken/FMdg7W8NKJZKRuFGG8mzmg'>bytecode</a>
```
Repo:  
